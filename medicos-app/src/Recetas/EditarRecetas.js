...
const EditarRecetas = () => {
    ...
    useEffect(() => {
        axios.get(`http://mindsetgx2020-001-site3.atempurl.com/api/Recetas/${id}`)
        .then(res => {
      ...
      function ObtenerRecetas(idReceta){
        axios.get(`http://mindsetgx2020-001-site3.atempurl.com/api/Paciente/${idReceta}`)
        .then(res => {
          const listaPa = res.data;
          setLista(listaPa);
          console.log(listaPa);
    ...
    function editarRecetas(receta) {
        if (
            ...
            axios.put(`http://mindsetgx2020-001-site3.atempurl.com/api/Recetas/${id}`, recetasDTO)
            .then(res => {
              swal({
