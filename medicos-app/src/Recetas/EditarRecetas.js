...
const EditarRecetas = () => {
    ...
    useEffect(() => {
        axios.get(`https://sistemamedicoapi20210916185716.azurewebsites.net/api/Recetas/${id}`)
        .then(res => {
      ...
      function ObtenerRecetas(idReceta){
        axios.get(`https://sistemamedicoapi20210916185716.azurewebsites.net/api/Paciente/${idReceta}`)
        .then(res => {
          const listaPa = res.data;
          setLista(listaPa);
          console.log(listaPa);
    ...
    function editarRecetas(receta) {
        if (
            ...
            axios.put(`https://sistemamedicoapi20210916185716.azurewebsites.net/api/Recetas/${id}`, recetasDTO)
            .then(res => {
              swal({
